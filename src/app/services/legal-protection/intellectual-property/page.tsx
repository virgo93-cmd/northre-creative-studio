...
export const metadata = {
  title: "Intellectual Property - NORTHRE CREATIVE STUDIO",
  description: "Amankan aset merek dagang, hak cipta karya kreatif, dan desain industri bisnis Anda secara hukum resmi.",
};
