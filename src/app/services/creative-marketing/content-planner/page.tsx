...
import { contentPlannerContent } from "@/config/services/content-planner";

export const metadata = {
  title: "Content Planner - NORTHRE CREATIVE STUDIO",
  description: "Perancangan arsitektur strategi dan kalender editorial konten jangka panjang.",
};

// Objek pemetaan Ikon SVG khusus untuk mempercantik judul kustom tiap pilar layanan planning
...
// Judul pilar kustom strategis untuk memperkuat sektor perencanaan konten siber
const attractivePillarTitles: Record<string, string> = {
  "pillar-1": "Auditing & Market Research",
  "pillar-2": "Content Pillars Blueprint",
  "pillar-3": "Editorial Board & Scheduling",
  "pillar-4": "Data Analytics & Performance Brief",
};

export default function ContentPlannerPage() {
  const { hero, pillars, benefits, workflow, portfolio } = contentPlannerContent;
        ...
        <section className="relative w-full min-h-120 flex items-center rounded-3xl overflow-hidden border border-neutral-900/40 bg-black shadow-2xl p-8 md:p-16 group">
          ...
          <div className="absolute inset-y-0 right-0 w-full lg:w-1/2 h-full z-0 pointer-events-none overflow-hidden">
            <div className="relative w-full h-full opacity-40 group-hover:opacity-50 transition-opacity duration-700">
              <Image
                src={hero.imagePath}
                alt="Northre Content Planner Hero Placeholder Visual"
                fill
                priority
          ...
          <div className="max-w-180 space-y-5 relative z-20">
            ...
            <h1 className="text-4xl md:text-6xl font-black text-white tracking-tight leading-none uppercase pt-2">
              Content <br />
              <span className="text-neutral-500">Planner</span>
            </h1>
