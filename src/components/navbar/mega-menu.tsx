  ...
  return (
    <div
      ...
      */
      ...
      className={`absolute top-full left-0 w-full border-b border-neutral-850/40 transition-all duration-300 ease-in-out overflow-hidden z-[-1] ${
        isOpen 
          ? "opacity-100 translate-y-0 pointer-events-auto py-14 h-auto bg-black backdrop-blur-2xl backdrop-saturate-150 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.7)]" 
    ...
    >
      <div className="max-w-360 mx-auto px-16 grid grid-cols-12 gap-12">
        ...
        <div className="col-span-3 space-y-3 border-r border-neutral-900 pr-8">
        ...
        <div className="col-span-9 grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-8 pl-4">
          ...
          {megaMenuCategories.map((category, catIndex) => (
            <div key={catIndex} className="space-y-5">
              <h4 className="text-xs font-bold text-neutral-500 uppercase tracking-widest border-b border-neutral-900 pb-2">
                ...
                {category.items.map((item, itemIndex) => (
                  ...
                  >
                    ...
                    <div className="space-y-0.5">
                      <h5 className="text-sm font-semibold text-white group-hover:text-neutral-400 transition-colors">
                        {item.title}
                      </h5>
