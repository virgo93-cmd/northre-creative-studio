...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-black border-t border-neutral-900 text-neutral-400 pt-14 pb-6">
      <div className="max-w-7xl mx-auto px-16 grid grid-cols-12 gap-12 mb-12">
        <div className="col-span-4 space-y-5">
          ...
          <p className="text-xs text-neutral-400 leading-relaxed font-medium pr-6">{siteConfig.description}</p>
        </div>
        ...
        {/* KOLOM SOSMED YANG SUDAH DIBENERIN */}
      ...
      <div className="max-w-7xl mx-auto px-16 border-t border-neutral-900/60 pt-6 flex justify-between text-[11px] font-medium text-neutral-600">
